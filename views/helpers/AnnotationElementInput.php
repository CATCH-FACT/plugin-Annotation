...
/**
 * Generate the form markup for entering one HTML input for an AnnotationElement.
 * 
 * @package Omeka\View\Helper
 */
class Omeka_View_Helper_AnnotationElementInput extends Zend_View_Helper_Abstract
{
    /**
     ...
     * @return string
     */
    public function annotationElementInput(Element $element, Omeka_Record_AbstractRecord $record, $index = 0, $value = '', $isHtml = false)
    {
