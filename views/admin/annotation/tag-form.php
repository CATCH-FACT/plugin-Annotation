<div id="tag-form" class="field">
    ...
    <div id="add-tags">
        ...
        <input element-name="tags" type="text" name="tags" size="20" id="tags" class="textinput" value="" />
    ...
    <div id="all-tags">
    <?php if ($tags): ?>
        <h3><?php echo __('Approved Tags'); ?></h3>
        
        <div class="tag-list">
        <ul id="all-tags-list">
            <?php foreach( $tags as $tag ): ?>
                <li>
                    <?php echo '<span element-name="tags" class="tag">' . $tag->name . '</span>'; 
