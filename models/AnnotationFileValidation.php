 ...
 * @copyright Center for History and New Media, 2010
 */
class AnnotationFileValidation
{
    const FILTER_NAME = 'file_ingest_validators';
        
    /**
     * TODO: Are there any validators in this set?
     * @var array Set of validators that will always apply to annotated files.
     */
    ...
    /**
     * Enable the file validation filter for the Annotation form.
     * 
     * @return void
     **/
