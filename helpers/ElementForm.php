 ...
 */
class Annotation_View_Helper_ElementForm extends Omeka_View_Helper_ElementForm
{
    ...
    {
        $this->_annotationTypeElement = $options['annotationTypeElement'];
   ...
   protected function _displayFormInput($inputNameStem, $value, $options=array())
    ...
    {
        return $this->_annotationTypeElement['data_type_name'];
    }
